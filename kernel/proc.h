...
//lab2:Give the ticket the number of tickets and the owner of the ticket
struct ticket {
	int owner;
...
struct proc {
  ...
  int syscallCounter;          // lab1:  Here we define the system call counter named as "syscallCounter"
